   ...
   // private Organization organization;
    ...
    private void populateCombo() {
        ...
        for (Type type : Organization.Type.values()) {
            if (type.getValue().equals(Type.FamilyAdmin.getValue())) {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/familyAdmin.jpg"))); // NOI18N
        ...
        for (Network n : ecoSystem.getNetworkList()) {
            for (Enterprise e : n.getEnterpriseDirectory().getEnterpriseList()) {
                if (e.getEnterpriseType().getValue().equals(Society.getValue()) && enterprise.getOrganizationName().equalsIgnoreCase(e.getOrganizationName())) {
                    if (type.equals(FamilyAdminOrganization.Type.FamilyAdmin)) {
    ...
    private void backJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backJButtonActionPerformed
        ...
        SocietyAdminWorkAreaJPanel socAdminwjp = (SocietyAdminWorkAreaJPanel) component;
