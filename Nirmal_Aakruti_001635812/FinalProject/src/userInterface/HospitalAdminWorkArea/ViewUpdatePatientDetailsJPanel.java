...
public class ViewUpdatePatientDetailsJPanel extends javax.swing.JPanel {
    ...
    private void addVerifiers() {
        ...
        patientIDJTextField.setInputVerifier(integerVerifier);
    ...
    private Boolean checkBlankInput() {
        if (patientIDJTextField.getText().length()==0 || patientIDJTextField.getText().trim().isEmpty()
                || primaryDocNameJTextField.getText().length() == 0 || primaryDocNameJTextField.getText().trim().isEmpty()
                || prefferedPharmacyJTextField.getText().length() == 0 || prefferedPharmacyJTextField.getText().trim().isEmpty()) {
            return false;
        } else {
            return true;
        }
